...
import aesoRankingsRouter from "./aeso_rankings";
import aesoMapRouter from "./aeso_map";
import aesoGenerationStackRouter from "./aeso_generation_stack";
...
router.use(aesoRankingsRouter);
router.use(aesoMapRouter);
router.use(aesoGenerationStackRouter);

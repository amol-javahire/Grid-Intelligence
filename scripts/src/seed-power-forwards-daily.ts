...
const REFERENCE: Record<string, { node: string; table: "ercot_hub_da_rt_hourly" | "caiso_hub_da_rt_hourly" }> = {
  ERCOT: { node: "HB_NORTH", table: "ercot_hub_da_rt_hourly" },
  ...
  CAISO: { node: "SP15", table: "caiso_hub_da_rt_hourly" },
};
